		...
		init : function(ed, url) {
			...
			ed.addCommand('mceSimpleImage', function() {
				ed.windowManager.open({
					file : url + '/dialog.htm',
					width : 320 + parseInt(ed.getLang('simpleimage.delta_width', 0)),
					height : 100 + parseInt(ed.getLang('simpleimage.delta_height', 0)),
					inline : 1
				}, {
			...
			ed.onNodeChange.add(function(ed, cm, n) {
				cm.setActive('simpleimage', n.nodeName == 'IMG');
			});
		},
